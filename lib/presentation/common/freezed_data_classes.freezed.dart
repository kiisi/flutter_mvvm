...
class _$RegisterObjectImpl implements _RegisterObject {
  _$RegisterObjectImpl(this.countryMobileCode, this.password, this.userName,
  ...
  @override
  String toString() {
    return 'RegisterObject(countryMobileCode: $countryMobileCode, password: $password, userName: $userName, email: $email, mobileNumber: $mobileNumber, profilePicture: $profilePicture)';
  }
  ...
  @override
  int get hashCode => Object.hash(runtimeType, countryMobileCode, password,
      userName, email, mobileNumber, profilePicture);
